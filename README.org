...
=cask= (not to be confused with homebrew cask) was an early
=npm/uv/cargo= for Emacs Lisp with hardcoded ties to MELPA, an early
=npmregistry/PyPi/crates.io=.  As of September 2026, emacs still lacks
an unimprovised =npm/uv/cargo=-like build tool.
